...
export default function EditProfile() {
  ...
  const handleSave = () => {
    const finalPronouns = selectedPronoun === 'Other' ? customPronoun : selectedPronoun;
    router.push({
      pathname: '/offer/view',
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput placeholder="Description" onChangeText={setDesc} style={styles.input} />

      <Text>Tags</Text>
      <TextInput placeholder="Tags" onChangeText={setTags} style={styles.input} />

      <Text>Date of Birth</Text>
      <Button title={dob || 'Select Date'} onPress={() => setShowDatePicker(true)} />
      {showDatePicker && (
        <DateTimePicker
          value={new Date()}
          mode="date"
      ...
      <Text>Gender</Text>
      <TextInput placeholder="Enter Gender" onChangeText={setGender} style={styles.input} />
