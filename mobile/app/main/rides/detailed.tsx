...
const DetailedRideInformation = () => {
  ...
  const [pickupCoords, setPickupCoords] = useState<RouteCoordinate | null>(
    null
  );
  const [dropoffCoords, setDropoffCoords] = useState<RouteCoordinate | null>(
    null
  );
  const [loading, setLoading] = useState(true);
  ...
  const bottomSheetHeight = screenHeight * 0.8; // 80% of screen
  const collapsedPosition = bottomSheetHeight - 140; // Show handle when collapsed
  const expandedPosition = screenHeight * 0.0;
      ...
      {pickupCoords && dropoffCoords && (
        <MapView
          ...
          initialRegion={{
            ...
            latitudeDelta:
              Math.abs(pickupCoords.latitude - dropoffCoords.latitude) * 1.5 ||
              0.01,
            longitudeDelta:
      ...
      >
        ...
        >
          ...
          <ScrollView style={styles.bottomSheetContent}>
            ...
            <View style={styles.rideDetails}>
              ...
              <View style={styles.detailRow}>
                ...
                <Text style={styles.detailValue}>
                  {rideInfo.has_car ? "Driver has car" : "Rideshare"}
                </Text>
              </View>
            ...
            <RequestManagement ride_id={rideInfo.id} />
          </ScrollView>
        </Animated.View>
      </PanGestureHandler>
    </GestureHandlerRootView>
