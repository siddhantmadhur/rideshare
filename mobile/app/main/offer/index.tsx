                ...
                <Card.Content>
                  <Text variant="titleMedium">
                    {(() => {
                      try {
                        const pickup =
                          typeof item.pickup === "string"
                            ? JSON.parse(item.pickup)
                            : item.pickup;
                        const dropoff =
                          typeof item.dropoff === "string"
                            ? JSON.parse(item.dropoff)
                            : item.dropoff;
                  ...
                  {item.has_car ? (
                    <Text>
                      Split Gas: {item.willing_to_split_gas ? "Yes" : "No"}
                    </Text>
                  ) : (
                    <Text>
                      Split Uber: {item.willing_to_split_uber ? "Yes" : "No"}
                    </Text>
                  )}
